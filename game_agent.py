...
def custom_score(game, player):
    ...
    diff = float(player_moves_left - opponent_moves_left)
...
def custom_score_2(game, player):
    ...
    my_blank_spaces = len(game.get_blank_spaces()) / 2
    score = my_blank_spaces + 2 * my_moves
...
def custom_score_3(game, player):
    ...
    float
        The heuristic value of the current game state to the specified player.
    """
    score1 = custom_score(game, player)
    score2 = custom_score_2(game, player)
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf"), maximizingPlayer = False):
        ...
        **********************************************************************
        ...
        for move in game.get_legal_moves():
            if v == self.max_value(game.forecast_move(move), depth, alpha, beta):
                return move
